...
/**
 * @description reducer for selectedPlayer that returns the selected player. The default state is an empty object. 
 * The action types are SET_SELECTED_PLAYER and CLEAR_SELECTED_PLAYER.
...
const selectedPlayerReducer = (state = {}, action) => {
  switch (action.type) {
    case SET_SELECTED_PLAYER:
      return action.payload;  // Sets the selected player from the payload

    case CLEAR_SELECTED_PLAYER:
      return {};  // Clears the selected player by returning an empty object
